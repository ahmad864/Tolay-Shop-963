      ...
      <div className="w-full max-w-md">
        ...
        <Tabs defaultValue="login" className="w-full">
          <TabsList className="grid w-full grid-cols-2 mb-6">
            <TabsTrigger value="login" className="font-tajawal">تسجيل الدخول</TabsTrigger>
            <TabsTrigger value="register" className="font-tajawal">إنشاء حساب</TabsTrigger>
          </TabsList>
              ...
              <CardContent>
                <form onSubmit={handleLogin} className="space-y-4">
                  <div className="space-y-2">
                    <Label htmlFor="login-email" className="font-tajawal">البريد الإلكتروني</Label>
                  ...
                  <div className="space-y-2">
                    <Label htmlFor="login-password" className="font-tajawal">كلمة المرور</Label>
                    <div className="relative">
          ...
          <TabsContent value="register">
            <Card>
              <CardHeader>
                ...
                <CardDescription className="font-tajawal">أنشئي حساباً جديداً للاستمتاع بتجربة تسوق مميزة</CardDescription>
              </CardHeader>
              <CardContent>
                <form onSubmit={handleRegister} className="space-y-4">
                  <div className="space-y-2">
                    <Label htmlFor="register-name" className="font-tajawal">الاسم الكامل</Label>
                    <div className="relative">
                  ...
                  <div className="space-y-2">
                    <Label htmlFor="register-email" className="font-tajawal">البريد الإلكتروني</Label>
                    <div className="relative">
                      <Mail className="absolute left-3 top-3 h-4 w-4 text-gray-400" />
                      <Input
                        id="register-email"
                  ...
                  <div className="space-y-2">
                    <Label htmlFor="register-phone" className="font-tajawal">رقم الهاتف</Label>
                    <div className="relative">
                  ...
                  <div className="space-y-2">
                    <Label htmlFor="register-password" className="font-tajawal">كلمة المرور</Label>
                    <div className="relative">
                      <Lock className="absolute left-3 top-3 h-4 w-4 text-gray-400" />
                      <Input
                  ...
                  <div className="space-y-2">
                    <Label htmlFor="register-confirm-password" className="font-tajawal">تأكيد كلمة المرور</Label>
                    <div className="relative">
                      <Lock className="absolute left-3 top-3 h-4 w-4 text-gray-400" />
                      <Input
