        ...
        <div className="grid grid-cols-2 md:grid-cols-3 lg:grid-cols-6 gap-8">
          {categories.map((category) => {
            ...
            return (
              ...
              >
                <div className="w-24 h-24 rounded-full bg-[#7f5c7e] flex items-center justify-center mb-4 shadow-lg hover:shadow-xl transition-all duration-300 group-hover:bg-[#6b4c6a] touch-manipulation">
