...
export function Hero() {
  ...
  const heroImages = ["/young-woman-22-purple-gradient.jpg", "/accessories-bed-purple-gradient.jpg"]
      ...
      <div className="relative h-80 lg:h-96 overflow-hidden">
        {heroImages.map((image, index) => (
          <img
            ...
            alt={
              index === 0 ? "فتاة عمرها 22 عام بخلفية بنفسجية مدرجة" : "إكسسوارات وحقائب وشالات بخلفية بنفسجية مدرجة"
            }
